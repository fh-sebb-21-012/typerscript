export function makeChart(
  ...
  function drawValue(index: number, value: number) {
    if (ctx == null) {
      return null;
    }
  ...
  function drawVGridLine(index: number) {
    if (ctx == null) {
      return null;
    }
  ...
  function drawHGridLine(value: number) {
    if (ctx == null) {
      return null;
    }
    ...
    ctx.fillText(value.toString(), 0, y);
  ...
  function drawCircle(index: number, value: number, radius = 4) {
    if (ctx == null) {
      return null;
    }
  ...
  function drawAxis(toX: number, toY: number, offsetX = 0, offsetY = 0) {
    if (ctx == null) {
      return null;
    }
